### THIS CODE IS A MONKEY PATCH OF 
### https://github.com/confident-ai/deepeval/blob/dbc0833c9519ff98c1f9757c129f499177f11e68/deepeval/metrics/g_eval/g_eval.py#L242
### To address issue using deepeval with our proxy (which is Azuer OpenAI under the hoold)
### Azure OpenAI  has a max value of 5 for the top_logprobs, while the original code has a hard coded default of 20
